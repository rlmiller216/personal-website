...
<div class="relative -mt-16 pt-16 bg-hero">
	<div class="max-w-6xl mx-auto px-6 py-8 sm:py-10">
		<h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-hero-foreground tracking-tight leading-tight">Open <span class="text-highlight">Source</span></h1>
	</div>
</div>
...
<section class="max-w-6xl mx-auto px-6 py-12">
	...
	{:else}
		<p class="text-muted-foreground">Open source tools coming soon - check back shortly!</p>
	{/if}
</section>
